...
const REVERSE_MIGRATION = createMigration(
  { x: 0.9, y: 0.5, rotation: 110 },
  { x: 0.8, y: 0.2, rotation: -90 },
);
...
const REVERSE_MIGRATION_2 = createMigration(
  { x: 0.8, y: 0.4, rotation: 80 },
  { x: 0.6, y: 0.1, rotation: 50 },
);
